...
# file = '3_evs.csv'
file = 'maths_sol_10'
book = 'Balaji Publication Mathematics Grade 10 Hindi'
grade = '10'
subject = 'Maths'
#----------------------connection--------------------------------------
...
for chapter in chapters:
		...
		tURL = 'https://www.upboardsolutions.com/balaji-class-10-maths-solutions-chapter-'+str(chapter)+'-ex-'+str(chapter)+'-'+str(count)
